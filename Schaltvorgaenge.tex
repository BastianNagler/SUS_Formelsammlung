...
\begin{gather*}
	i_c (t) = C \cdot \frac{du_c(t)}{dt} \qquad u_L (t) = L \cdot \frac{di_L(t)}{dt}
\end{gather*}

\subsection{Wichtige Verläufe}
\(f(t) = at\cdot e^{-at} \text{, Maximum bei } t=\frac{1}{a}\)
\begin{figure}[H]
	\includegraphics[width=0.2\textwidth]{Bilder/te-t.png}
\end{figure}