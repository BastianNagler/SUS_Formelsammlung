...
\begin{itemize}[leftmargin=*]
	...
	\item zu 45: $\gamma = \arctan \left(\frac{\omega}{a}\right)$
...
\end{array}$\\
\vspace{1.5em}
$\beta=\arctan\dfrac{z}{\omega_d \, \cos\varphi}$, Dämpfungsgrad,-maß, -konstante: $\vartheta = D =  \dfrac{\delta}{\omega_0} = \dfrac{a}{b}$
\newpage
\begin{multicols*}{2}
